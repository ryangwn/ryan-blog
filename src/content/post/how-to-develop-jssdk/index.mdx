...
SDK stands for `Software Development Kit`. JSSDK is a collection of exposed functions for developers to help the front-end realize specific needs. Developers can use JS-API to integrate and use certain specific functions in web pages, such as social sharing, map services, payment functions, etc. It usually includes the following modules:

1. Javascript Library: This is the core part of the SDK, which contains a series of pre-written Javascript codes that implement specific functions, such as user authentication, data analysis, social sharing, etc.
2. API Documentation: This part of the documentation describes in detail how to use each feature in the JSSDK package. It usually contains a list of functions and methods, and how to use them.
3. Sample code: This part shows how to use JSSDK in a real project. By reading and running the sample code, developers can better understand how to use JSSDK.
